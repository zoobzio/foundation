...
import Part from "#foundation/components/common/accordion/trigger.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("AccordionTrigger") } });

describe("common/accordion/Trigger", () => {
  it("renders with f-accordion-trigger class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-accordion-trigger");
  });
