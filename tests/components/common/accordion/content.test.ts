...
import Part from "#foundation/components/common/accordion/content.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("AccordionContent") } });

describe("common/accordion/Content", () => {
  it("renders with f-accordion-content class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-accordion-content");
  });
  ...
  it("renders the aria channel", () => {
    const wrapper = factory({ aria: { label: "Panel" } });
