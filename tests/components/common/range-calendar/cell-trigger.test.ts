...
import CellTrigger from "#foundation/components/common/range-calendar/cell-trigger.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(CellTrigger, {
    ...
    global: {
      stubs: {
        RangeCalendarCellTrigger: createScopedStub("RangeCalendarCellTrigger", { dayValue: "25" }),
      },
    },
  });

describe("common/range-calendar/CellTrigger", () => {
  it("renders with f-range-calendar-cell-trigger class", () => {
    expect(factory().classes()).toContain("f-range-calendar-cell-trigger");
  });
