...
import Prev from "#foundation/components/common/date-range-picker/prev.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Prev, {
    ...
    slots,
    global: {
      stubs: { DateRangePickerPrev: createScopedStub("DateRangePickerPrev", { disabled: true }) },
    },
  });

describe("common/date-range-picker/Prev", () => {
  it("renders with f-date-range-picker-prev class", () => {
    expect(factory().classes()).toContain("f-date-range-picker-prev");
  });
