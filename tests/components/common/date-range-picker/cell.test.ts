...
import Cell from "#foundation/components/common/date-range-picker/cell.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Cell, {
    ...
    slots,
    global: { stubs: rekaStubs("DateRangePickerCell") },
  });

describe("common/date-range-picker/Cell", () => {
  it("renders with f-date-range-picker-cell class", () => {
    expect(factory().classes()).toContain("f-date-range-picker-cell");
  });
