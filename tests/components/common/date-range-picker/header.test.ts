...
import Header from "#foundation/components/common/date-range-picker/header.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Header, { props, slots, global: { stubs: rekaStubs("DateRangePickerHeader") } });

describe("common/date-range-picker/Header", () => {
  it("renders with f-date-range-picker-header class", () => {
    expect(factory().classes()).toContain("f-date-range-picker-header");
  });
