...
import GridHead from "#foundation/components/common/date-range-picker/grid-head.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(GridHead, { props, slots, global: { stubs: rekaStubs("DateRangePickerGridHead") } });

describe("common/date-range-picker/GridHead", () => {
  it("renders with f-date-range-picker-grid-head class", () => {
    expect(factory().classes()).toContain("f-date-range-picker-grid-head");
  });
