...
import Trigger from "#foundation/components/common/date-range-picker/trigger.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Trigger, { props, slots, global: { stubs: rekaStubs("DateRangePickerTrigger") } });

describe("common/date-range-picker/Trigger", () => {
  it("renders with f-date-range-picker-trigger class", () => {
    expect(factory().classes()).toContain("f-date-range-picker-trigger");
  });
