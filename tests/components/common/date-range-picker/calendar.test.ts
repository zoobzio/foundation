...
import Calendar from "#foundation/components/common/date-range-picker/calendar.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Calendar, {
    ...
    global: {
      stubs: {
        DateRangePickerCalendar: createScopedStub("DateRangePickerCalendar", {
          weekDays: ["Su", "Mo"],
          grid: [],
        }),
      },
...
describe("common/date-range-picker/Calendar", () => {
  it("renders with f-date-range-picker-calendar class", () => {
    expect(factory().classes()).toContain("f-date-range-picker-calendar");
  });
