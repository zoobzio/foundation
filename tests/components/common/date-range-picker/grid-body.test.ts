...
import GridBody from "#foundation/components/common/date-range-picker/grid-body.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(GridBody, { props, slots, global: { stubs: rekaStubs("DateRangePickerGridBody") } });

describe("common/date-range-picker/GridBody", () => {
  it("renders with f-date-range-picker-grid-body class", () => {
    expect(factory().classes()).toContain("f-date-range-picker-grid-body");
  });
