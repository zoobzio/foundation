...
import Input from "#foundation/components/common/date-range-picker/input.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Input, {
    props: { part: "day", ...props },
    slots,
    global: { stubs: rekaStubs("DateRangePickerInput") },
  });

describe("common/date-range-picker/Input", () => {
  it("renders with f-date-range-picker-input class", () => {
    expect(factory().classes()).toContain("f-date-range-picker-input");
  });
