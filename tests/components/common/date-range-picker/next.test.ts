...
import Next from "#foundation/components/common/date-range-picker/next.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Next, {
    ...
    slots,
    global: {
      stubs: { DateRangePickerNext: createScopedStub("DateRangePickerNext", { disabled: false }) },
    },
  });

describe("common/date-range-picker/Next", () => {
  it("renders with f-date-range-picker-next class", () => {
    expect(factory().classes()).toContain("f-date-range-picker-next");
  });
