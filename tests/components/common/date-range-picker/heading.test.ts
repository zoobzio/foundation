...
import Heading from "#foundation/components/common/date-range-picker/heading.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Heading, {
    ...
    global: {
      stubs: {
        DateRangePickerHeading: createScopedStub("DateRangePickerHeading", { headingValue: "April 2026" }),
      },
    },
  });

describe("common/date-range-picker/Heading", () => {
  it("renders with f-date-range-picker-heading class", () => {
    expect(factory().classes()).toContain("f-date-range-picker-heading");
  });
