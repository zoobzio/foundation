...
import Part from "#foundation/components/common/toast/description.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("ToastDescription") } });

describe("common/toast/Description", () => {
  it("renders with f-toast-description class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-toast-description");
  });
