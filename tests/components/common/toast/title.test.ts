...
import Part from "#foundation/components/common/toast/title.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("ToastTitle") } });

describe("common/toast/Title", () => {
  it("renders with f-toast-title class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-toast-title");
  });
