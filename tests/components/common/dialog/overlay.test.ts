...
import Part from "#foundation/components/common/dialog/overlay.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("DialogOverlay") } });

describe("common/dialog/Overlay", () => {
  it("renders with f-dialog-overlay class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-dialog-overlay");
  });
