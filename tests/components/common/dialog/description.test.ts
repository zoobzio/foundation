...
import Part from "#foundation/components/common/dialog/description.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("DialogDescription") } });

describe("common/dialog/Description", () => {
  it("renders with f-dialog-description class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-dialog-description");
  });
