...
import Trigger from "#foundation/components/common/popover/trigger.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Trigger, { props, slots, global: { stubs: rekaStubs("PopoverTrigger") } });

describe("common/popover/Trigger", () => {
  it("renders with f-popover-trigger class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-popover-trigger");
  });
