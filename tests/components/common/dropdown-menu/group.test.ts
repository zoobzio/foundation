...
import Part from "#foundation/components/common/dropdown-menu/group.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("DropdownMenuGroup") } });

describe("common/dropdown-menu/Group", () => {
  it("renders with f-dropdown-menu-group class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-dropdown-menu-group");
  });
  ...
  it("renders the aria channel", () => {
    const wrapper = factory({ aria: { label: "Group" } });
