...
import Part from "#foundation/components/common/dropdown-menu/separator.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("DropdownMenuSeparator") } });

describe("common/dropdown-menu/Separator", () => {
  it("renders with f-dropdown-menu-separator class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-dropdown-menu-separator");
  });
