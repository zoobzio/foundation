...
import Part from "#foundation/components/common/dropdown-menu/label.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("DropdownMenuLabel") } });

describe("common/dropdown-menu/Label", () => {
  it("renders with f-dropdown-menu-label class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-dropdown-menu-label");
  });
