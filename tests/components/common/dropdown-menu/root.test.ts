...
import Root from "#foundation/components/common/dropdown-menu/root.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Root, { props, slots, global: { stubs: rekaStubs("DropdownMenuRoot") } });

describe("common/dropdown-menu/Root", () => {
  it("renders with f-dropdown-menu-root class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-dropdown-menu-root");
  });
