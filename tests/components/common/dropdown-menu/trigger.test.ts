...
import Part from "#foundation/components/common/dropdown-menu/trigger.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("DropdownMenuTrigger") } });

describe("common/dropdown-menu/Trigger", () => {
  it("renders with f-dropdown-menu-trigger class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-dropdown-menu-trigger");
  });
