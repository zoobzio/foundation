...
import Part from "#foundation/components/common/scroll-area/corner.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Part, { props, slots, global: { stubs: rekaStubs("ScrollAreaCorner") } });

describe("common/scroll-area/Corner", () => {
  it("renders with f-scroll-area-corner class", () => {
    const wrapper = factory();
    expect(wrapper.classes()).toContain("f-scroll-area-corner");
  });
