...
import Prev from "#foundation/components/common/calendar/prev.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Prev, {
    ...
    slots,
    global: {
      stubs: { CalendarPrev: createScopedStub("CalendarPrev", { disabled: true }) },
    },
  });

describe("common/calendar/Prev", () => {
  it("renders with f-calendar-prev class", () => {
    expect(factory().classes()).toContain("f-calendar-prev");
  });
