...
import GridHead from "#foundation/components/common/calendar/grid-head.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(GridHead, { props, slots, global: { stubs: rekaStubs("CalendarGridHead") } });

describe("common/calendar/GridHead", () => {
  it("renders with f-calendar-grid-head class", () => {
    expect(factory().classes()).toContain("f-calendar-grid-head");
  });
