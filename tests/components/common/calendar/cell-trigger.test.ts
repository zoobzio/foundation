...
import CellTrigger from "#foundation/components/common/calendar/cell-trigger.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(CellTrigger, {
    ...
    global: {
      stubs: {
        CalendarCellTrigger: createScopedStub("CalendarCellTrigger", { dayValue: "25" }),
      },
    },
  });

describe("common/calendar/CellTrigger", () => {
  it("renders with f-calendar-cell-trigger class", () => {
    expect(factory().classes()).toContain("f-calendar-cell-trigger");
  });
