...
import Next from "#foundation/components/common/calendar/next.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Next, {
    ...
    slots,
    global: {
      stubs: { CalendarNext: createScopedStub("CalendarNext", { disabled: false }) },
    },
  });

describe("common/calendar/Next", () => {
  it("renders with f-calendar-next class", () => {
    expect(factory().classes()).toContain("f-calendar-next");
  });
