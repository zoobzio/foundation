...
import Header from "#foundation/components/common/calendar/header.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Header, { props, slots, global: { stubs: rekaStubs("CalendarHeader") } });

describe("common/calendar/Header", () => {
  it("renders with f-calendar-header class", () => {
    expect(factory().classes()).toContain("f-calendar-header");
  });
