...
import GridBody from "#foundation/components/common/calendar/grid-body.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(GridBody, { props, slots, global: { stubs: rekaStubs("CalendarGridBody") } });

describe("common/calendar/GridBody", () => {
  it("renders with f-calendar-grid-body class", () => {
    expect(factory().classes()).toContain("f-calendar-grid-body");
  });
