...
import Heading from "#foundation/components/common/calendar/heading.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Heading, {
    ...
    global: {
      stubs: {
        CalendarHeading: createScopedStub("CalendarHeading", { headingValue: "April 2026" }),
      },
    },
  });

describe("common/calendar/Heading", () => {
  it("renders with f-calendar-heading class", () => {
    expect(factory().classes()).toContain("f-calendar-heading");
  });
