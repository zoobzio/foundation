...
import GridRow from "#foundation/components/common/calendar/grid-row.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(GridRow, { props, slots, global: { stubs: rekaStubs("CalendarGridRow") } });

describe("common/calendar/GridRow", () => {
  it("renders with f-calendar-grid-row class", () => {
    expect(factory().classes()).toContain("f-calendar-grid-row");
  });
