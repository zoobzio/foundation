...
import HeadCell from "#foundation/components/common/calendar/head-cell.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(HeadCell, { props, slots, global: { stubs: rekaStubs("CalendarHeadCell") } });

describe("common/calendar/HeadCell", () => {
  it("renders with f-calendar-head-cell class", () => {
    expect(factory().classes()).toContain("f-calendar-head-cell");
  });
