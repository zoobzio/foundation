...
import Prev from "#foundation/components/common/date-picker/prev.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Prev, {
    ...
    slots,
    global: {
      stubs: { DatePickerPrev: createScopedStub("DatePickerPrev", { disabled: true }) },
    },
  });

describe("common/date-picker/Prev", () => {
  it("renders with f-date-picker-prev class", () => {
    expect(factory().classes()).toContain("f-date-picker-prev");
  });
