...
import Cell from "#foundation/components/common/date-picker/cell.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Cell, {
    ...
    slots,
    global: { stubs: rekaStubs("DatePickerCell") },
  });

describe("common/date-picker/Cell", () => {
  it("renders with f-date-picker-cell class", () => {
    expect(factory().classes()).toContain("f-date-picker-cell");
  });
