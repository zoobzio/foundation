...
import Grid from "#foundation/components/common/date-picker/grid.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Grid, { props, slots, global: { stubs: rekaStubs("DatePickerGrid") } });

describe("common/date-picker/Grid", () => {
  it("renders with f-date-picker-grid class", () => {
    expect(factory().classes()).toContain("f-date-picker-grid");
  });
