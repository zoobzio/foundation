...
import Next from "#foundation/components/common/date-picker/next.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Next, {
    ...
    slots,
    global: {
      stubs: { DatePickerNext: createScopedStub("DatePickerNext", { disabled: false }) },
    },
  });

describe("common/date-picker/Next", () => {
  it("renders with f-date-picker-next class", () => {
    expect(factory().classes()).toContain("f-date-picker-next");
  });
