...
import Content from "#foundation/components/common/date-picker/content.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(Content, { props, slots, global: { stubs: rekaStubs("DatePickerContent") } });

describe("common/date-picker/Content", () => {
  it("renders with f-date-picker-content class", () => {
    expect(factory().classes()).toContain("f-date-picker-content");
  });
