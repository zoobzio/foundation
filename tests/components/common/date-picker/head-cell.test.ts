...
import HeadCell from "#foundation/components/common/date-picker/head-cell.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(HeadCell, { props, slots, global: { stubs: rekaStubs("DatePickerHeadCell") } });

describe("common/date-picker/HeadCell", () => {
  it("renders with f-date-picker-head-cell class", () => {
    expect(factory().classes()).toContain("f-date-picker-head-cell");
  });
