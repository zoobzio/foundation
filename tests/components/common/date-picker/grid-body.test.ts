...
import GridBody from "#foundation/components/common/date-picker/grid-body.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(GridBody, { props, slots, global: { stubs: rekaStubs("DatePickerGridBody") } });

describe("common/date-picker/GridBody", () => {
  it("renders with f-date-picker-grid-body class", () => {
    expect(factory().classes()).toContain("f-date-picker-grid-body");
  });
