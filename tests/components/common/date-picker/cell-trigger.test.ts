...
import CellTrigger from "#foundation/components/common/date-picker/cell-trigger.vue";
...
const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(CellTrigger, {
    ...
    global: {
      stubs: {
        DatePickerCellTrigger: createScopedStub("DatePickerCellTrigger", { dayValue: "25" }),
      },
    },
  });

describe("common/date-picker/CellTrigger", () => {
  it("renders with f-date-picker-cell-trigger class", () => {
    expect(factory().classes()).toContain("f-date-picker-cell-trigger");
  });
