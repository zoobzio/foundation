...
import GridHead from "#foundation/components/common/date-picker/grid-head.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(GridHead, { props, slots, global: { stubs: rekaStubs("DatePickerGridHead") } });

describe("common/date-picker/GridHead", () => {
  it("renders with f-date-picker-grid-head class", () => {
    expect(factory().classes()).toContain("f-date-picker-grid-head");
  });
