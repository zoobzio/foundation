...
import GridRow from "#foundation/components/common/date-picker/grid-row.vue";

const factory = (props: Record<string, unknown> = {}, slots: Record<string, unknown> = {}) =>
  mount(GridRow, { props, slots, global: { stubs: rekaStubs("DatePickerGridRow") } });

describe("common/date-picker/GridRow", () => {
  it("renders with f-date-picker-grid-row class", () => {
    expect(factory().classes()).toContain("f-date-picker-grid-row");
  });
