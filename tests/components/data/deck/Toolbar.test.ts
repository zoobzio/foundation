...
import { commonStubs, coreStubs, createAllSlotsStub } from "#test/stubs";
import { createMockDeck } from "#test/support/helpers/mock-deck";
import { fakeRows } from "#test/support/data/table";
import type { FakeRow } from "#test/support/data/table";
import type { Deck } from "#foundation/types/data/deck";

const Toolbar = (await import("#foundation/components/data/deck/Toolbar.vue")).default as DefineComponent;
