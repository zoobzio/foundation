...
import { commonStubs, coreStubs, createStub, createAllSlotsStub } from "#test/stubs";
...
const Widget = (await import("#foundation/components/data/chart/Widget.vue")).default as DefineComponent;
