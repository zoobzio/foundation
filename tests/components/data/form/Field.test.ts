...
import { mountFormField } from "#test/support/fixtures/data";
...
describe("DataFormField", () => {
  ...
  // ---------------------------------------------------------------------------
  // Event handlers — common elements (Input, Textarea): native events
  // ---------------------------------------------------------------------------

  describe("event handlers (common elements)", () => {
  ...
  // ---------------------------------------------------------------------------
  // Event handlers — core components: emit update:modelValue
  // ---------------------------------------------------------------------------

  describe("event handlers (core components)", () => {
    describe("Select", () => {
