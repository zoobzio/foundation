<script lang="ts">
import type { DataDeckProps } from "#foundation/types/data/deck-widget";
</script>

<script setup lang="ts" generic="T">
import { computed, onBeforeUnmount, onMounted, useId, useLazyAsyncData, useTemplateRef } from "#imports";
