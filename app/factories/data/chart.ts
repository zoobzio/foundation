import { computed, inject, ref, useNuxtApp, useState, watchEffect } from "#imports";
import { WIDGET_CONFIGS } from "#foundation/constants/data/table";
import { BASE_OPTIONS, PALETTE, VARIANT_LABELS } from "#foundation/constants/data/chart";
import type {
  Chart,
  DataChartConfig,
  DataChartVariant,
...
import { DataChartSnapshotSchema } from "#foundation/schemas/data/chart";
