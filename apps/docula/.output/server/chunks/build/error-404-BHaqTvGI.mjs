import { _ as __nuxt_component_0 } from './nuxt-link-Df9NoxNv.mjs';
import { v as vueExports, u as useHead, s as serverRenderer_cjs_prodExports } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-ce498953><div class="max-w-520px text-center" data-v-ce498953><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-ce498953>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.statusCode)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-ce498953>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.statusMessage)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-ce498953>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-ce498953>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@4.2.0_@parcel+watcher@2.5.1_@types+node@24.10.0_@vue+compiler-sfc@3.5.24_better-sqlite3@_zm53upo5yznhxihreetxz4lh2m/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ce498953"]]);

export { error404 as default };
//# sourceMappingURL=error-404-BHaqTvGI.mjs.map
