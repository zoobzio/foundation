...
import { codeViewTheme } from "../utils/codemirror-theme";
import { resolveLanguage } from "../utils/codemirror-lang";
import { codeViewSearch, dispatchSearch, findNextMatch, findPrevMatch } from "../utils/codemirror-search";
import type { CodeViewProps } from "../types/code-view";
</script>
